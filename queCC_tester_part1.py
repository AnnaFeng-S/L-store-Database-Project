...
from lstore.quecc import QueCC
...
grades_table = db.create_table('QueCC', 5, 0)
...
t.add_query(query.update, grades_table, key, *[None, None, None, None, None])
quecc = QueCC(num_threads)
for i in range(number_of_transactions):
    quecc.add_transaction(insert_transactions[i])
